...
export const PlacesVisited = () => {
        ...
        setInterval(() => {
          setImageCarouselData((prev) => {
            ...
            return {
              ...
              currBgImage: TextData.placesVisited[newCurrItemIdx].src,
              currBgImageAlt: TextData.placesVisited[newCurrItemIdx].alt,
            };
          });
        }, 2500);
      }
  ...
  const animateOut = (idx: number) => {
    ...
    animate(`#grid-item-${idx}`, { y: 0 }, { ease: "easeOut", duration: 0.5 });
    ...
    <>
      ...
      <div className="container" ref={scope}>
        ...
        <motion.div className="image-grid" ref={ref}>
          {TextData.placesVisited.map((pl, idx) => (
            <div className="item">
              <p className="location-text" id={`location-text-${idx}`}>
                Mount Ranier
              </p>
              ...
              >
                <circle cx="50%" cy="50%" r="5" stroke="white" fill="none" />
              </svg>
            </div>
          ))}
        </motion.div>
